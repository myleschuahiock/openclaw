      ...
      if (evt.action === "finished") {
        ...
        void appendCronRunLog(
          logPath,
          {
            ...
            workflowFailureCodes: evt.workflowFailureCodes,
            workflowExitCode: evt.workflowExitCode,
            workflowTerminationSignal: evt.workflowTerminationSignal,
            ...
            runKind: evt.runKind,
            runAtMs: evt.runAtMs,
            scheduledRunAtMs: evt.scheduledRunAtMs,
            catchupForRunAtMs: evt.catchupForRunAtMs,
            durationMs: evt.durationMs,
            nextRunAtMs: evt.nextRunAtMs,
            model: evt.model,
